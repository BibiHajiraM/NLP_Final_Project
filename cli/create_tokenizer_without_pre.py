...
def main():
    ...
    # Use "query" field of the dataset to get SQL query
    target_iterator = (item["query"] for item in raw_datasets["train"])
    ...
    logger.info(f"Saving source to {args.save_dir}/sql_tokenizer")
    target_tokenizer.save_pretrained(os.path.join(args.save_dir, "sql_tokenizer"))
